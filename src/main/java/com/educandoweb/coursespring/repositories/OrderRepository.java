 ...
 *
 * Injeção de dependência: quem precisar de {@code OrderRepository} (ex.: {@code OrderService},
 * {@code TestConfig}) declara o tipo desta interface; o Spring injeta a implementação gerada.
 *
 * @param Order tipo da entidade gerenciada
 * @param Long tipo da chave primária ({@link Order#getId})
 */
public interface OrderRepository extends JpaRepository<Order, Long> {
	/*
	 * JpaRepository<Order, Long> traz de graça muitos métodos: save, saveAll, findById, findAll, delete, etc.
